...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "q1138006034@gmail",
    href: "mailto:q1138006034@gmail.com",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">XERA-2011</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m XERA-2011, a Fullstack developer passionate about
